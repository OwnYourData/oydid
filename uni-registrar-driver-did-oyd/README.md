...
In general, each DID operation (create / update / revoke) can     
...
* `log_revoke`: **revoke OYDID log entry** (JSON object) - entry for the OYDID log that contains information that a previous termination entry does not indiciate that the resolution process is complete    
